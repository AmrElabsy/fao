<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="addroom.aspx.cs" Inherits="Hotel.addroom" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
	    <div class="page-body-navbar1 col-lg-10 col-lg-offset-3 col-md-6 col-md-offset-5 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 ">
		    <h2 class="signup text-center">Add Room</h2>
		    <form class="form-horizontal form-padding" runat="server">
			    ...
			    <div class="text-center col-sm-4 col-lg-4 col-sm-offset-4 col-lg-offset-4">
                    <asp:Button ID="Button1" runat="server" Text="Add Room" CssClass="btn btn-default btn-lg center-block" OnClick="add_room"/>
			    </div>
		    </form>
	    </div>
    </div>
